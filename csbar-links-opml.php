 ...
 * another. Links aren't exported by the csbar export, so this file handles
 * that.
 *
 * This file is not added by default to csbar theme pages when outputting
...
foreach ( (array) $cats as $cat ) :
	/** This filter is documented in csbar-includes/bookmark-template.php */
